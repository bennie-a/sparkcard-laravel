...
use App\Http\Controllers\Baseshop\BaseApiController;
use App\Http\Controllers\Baseshop\BaseOAuthController;
...
Route::get('base/oauth/connect', [BaseOAuthController::class, 'connect']);
Route::post('base/oauth/callback', [BaseOAuthController::class, 'callback']);
Route::get('base/oauth/status', [BaseOAuthController::class, 'status']);
