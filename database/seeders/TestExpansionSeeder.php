...
class TestExpansionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Expansion::create(['attr' => 'MH1', 'name' => 'モダンホライゾン', 'notion_id' => 'xxxxssss-xxxx1e', 'release_date' => '2024-06-14']);
        ...
        Expansion::create(['attr' => 'TDM', 'name' => 'タルキール:龍嵐録', 'notion_id' => 'b6e4f2a2-93c8-489c-b1f0-2d7c9azb5fea', 'release_date' => '2025-04-11']);
